				...
				<div class="card crd-ho mt-5">
					<div class="card-body text-center">
						<img alt="" src="Book/<%=b.getPhotoName()%>"
							style="width: 120px; height: 170px" class="img-thumbnail mb-2">
						<p>
						...
						<div class="row justify-content-center">
							...
							<a href="cart?bid=<%=b.getBookId()%>&&uid=<%=u.getId()%>"
								class="btn btn-outline-danger btn-sm px-3 py-1 rounded-pill shadow-sm m-1">
							...
							%>
								 ...
								 <a href="view_books.jsp?bid=<%=b.getBookId()%>"
									class="btn btn-outline-primary btn-sm px-3 py-1 rounded-pill shadow-sm m-1 d-flex align-items-center">
									<i class="fas fa-info-circle me-2"></i> View Details
								</a> <a href="#"
									class="btn btn-outline-danger btn-sm px-3 py-1 rounded-pill shadow-sm m-1 d-flex align-items-center">
